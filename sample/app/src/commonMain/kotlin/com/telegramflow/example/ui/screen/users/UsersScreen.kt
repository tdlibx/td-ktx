...
import com.telegramflow.example.util.ReportDrawnWhen

@Composable
fun UsersScreen(
    presenter: UsersPresenter = run {
        val repo = LocalTelegramRepository.current
        val scope = rememberCoroutineScope()
        remember(repo, scope) { UsersPresenter(repo, scope) }
    },
    users: State<List<User>> = presenter.users.collectAsState()
) {
