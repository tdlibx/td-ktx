...
class BuildThreadsForChatUseCase(
    ...
    private fun findTextMatches(text: String): List<TextMatch> {
        ...
        urlRegex.findAll(text).forEach { match ->
            results += TextMatch.Link(start = match.range.first, end = match.range.last + 1, url = match.value)
        }
    ...
    companion object {
        ...
        private val urlRegex = """https?://[a-zA-Z0-9-.]+\.[a-zA-Z]{2,}(?:/[^\s]*)?""".toRegex()
